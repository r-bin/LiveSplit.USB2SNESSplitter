...
namespace LiveSplit.UI.Components
{
    public partial class ComponentSettings : UserControl
    {
        ...
        public ComponentSettings()
        {
            ...
            Device = string.Empty;
            this.txtDevice.DataBindings.Add("Text", this, "Device", false,
        ...
        public XmlNode GetSettings(XmlDocument document)
        {
            ...
            settings_node.AppendChild(SettingsHelper.ToElement(document, "Device", Device));
        ...
        public void SetSettings(XmlNode settings)
        {
            ...
            if (!element.IsEmpty)
            {
                Device = SettingsHelper.ParseString(element["Device"], string.Empty);
        ...
        private void treeContextMenu2_Opening(object sender, System.ComponentModel.CancelEventArgs e)
        {
